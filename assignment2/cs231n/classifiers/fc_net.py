...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        scores, cache_h2 = affine_forward(out1, self.params['W2'], self.params['b2'])
        ...
        dx, dW2, db2 = affine_backward(dx, cache_h2)
        dx, dW1, db1 = affine_relu_backward(dx, cache_h1)
    ...
    def loss(self, X, y=None):
        ...
        for i in range(1, self.num_layers+1):
            ...
            if i != (self.num_layers):
                ...
                current_caches['affine'] = cache_affine
                ...
                if self.use_batchnorm:
                    ...
                    current_caches['bn'] = cache_bn
                
                out, cache_relu = relu_forward(out)
                current_caches['relu'] = cache_relu
                
                if self.use_dropout:
                    out, cache_dropout = dropout_forward(out, self.dropout_param)
                    current_caches['dropout'] = cache_dropout
            else:
                out, cache_affine = affine_forward(out, W, b)
                current_caches['affine'] = cache_affine
            caches.append(current_caches)
        ...
        for i in range(self.num_layers, 0, -1):
            ...
            if i == (self.num_layers):
                ...
                if self.use_batchnorm:
                    dx, dgamma, dbeta = batchnorm_backward(dx, cache['bn'])
