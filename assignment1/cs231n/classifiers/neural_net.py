...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    grad_h = dscores.dot(W2.T)
    grad_h[hidden_layer <= 0] = 0
    
    grads['W1'] = X.T.dot(grad_h) + 2*reg*W1
    grads['b1'] = np.sum(grad_h, axis=0, keepdims=True)
  ...
  def train(self, X, y, X_val, y_val,
    ...
    for it in xrange(num_iters):
      ...
      self.params['W1'] += -learning_rate * grads['W1'] # perform parameter update
